...
namespace Mariasek.SharedClient
{
    ...
    {    
        ...
        public float RiskFactorHundred { get; set; }    //xml-only
        ...
        public void ResetThresholds()
        {
            ...
            RiskFactorHundred = 0.05f;   //pouziva se pri posuzovani riskantniho kila
