    ...
    public class SettingsBox : ScrollBox
    {
        ...
        public SettingsBox(GameComponent parent) : base(parent)
        {
            ...
            _whenToShuffleSelector = new LeftRightSelector(this)
            {
                ...
                Width = 270,
                Group = 1,
                Items = new SelectorItems() { { "Nikdy", ShuffleTrigger.Never }, { "Po restartu", ShuffleTrigger.AfterRestart }, { "Jednou za den", ShuffleTrigger.Daily }, { "Po ložené hře", ShuffleTrigger.AfterAutomaticVictory }, { "Po každé hře", ShuffleTrigger.Always } },
                UseCommonScissorRect = true
            };
