...
namespace Mariasek.Console
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            System.Console.WriteLine("{0} has {1} the game ({2} {3}).", g.GameStartingPlayer.Name, 
        ...
        static void CardPlayed(object sender, Round r)
        {
            if (r.c3 != null)
            {
                System.Console.WriteLine("{0}: {1}{2}{3}", r.player3.Name, 
                                                           r.c3, 
            ...
            {
                System.Console.WriteLine("{0}: {1}{2}{3}", r.player2.Name,
                                                           r.c2,
            ...
            else
            {
                ...
                System.Console.WriteLine("{0}: {1}{2}{3}", r.player1.Name,
                                                           r.c1,
